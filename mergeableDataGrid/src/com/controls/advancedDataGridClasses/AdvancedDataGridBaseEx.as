 ...
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.ITEM_EDIT_BEGINNING
 */
[Event(name="itemEditBeginning", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]

/**
 *  Dispatched when the <code>editedItemPosition</code> property has been set
 *  and the item can be edited.
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.ITEM_EDIT_BEGIN
 */
[Event(name="itemEditBegin", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]

/**
 *  Dispatched when an item editing session ends for any reason.
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.ITEM_EDIT_END
 */
[Event(name="itemEditEnd", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]
 ...
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.ITEM_FOCUS_IN
 */
[Event(name="itemFocusIn", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]
 ...
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.ITEM_FOCUS_OUT
 */
[Event(name="itemFocusOut", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]
 ...
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.COLUMN_STRETCH
 */
[Event(name="columnStretch", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]
 ...
 * </p>
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.HEADER_RELEASE
 */
[Event(name="headerRelease", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]

/**
 *  Dispatched when sorting is to be performed on the AdvancedDataGrid control.
 *
 *  @eventType com.controls.advancedDataGridClasses.AdvancedDataGridEvent.SORT
 */
[Event(name="sort", type="com.controls.advancedDataGridClasses.AdvancedDataGridEvent")]
...
public class AdvancedDataGridBaseEx extends AdvancedDataGridBase implements IIMESupport
{
    ...
    public function AdvancedDataGridBaseEx()
    {
        ...
        itemRenderer = new ContextualClassFactory(AdvancedDataGridItemRenderer, getNonNullSystemManager());
    ...
    */
    override public function get itemRenderer():IFactory
    {
      ...
      var flexModuleFactory:IFlexModuleFactory = getFontContext(fontName, bold, italic);
          ...
          super.itemRenderer = new ContextualClassFactory(AdvancedDataGridItemRenderer, flexModuleFactory);
    ...
    [Inspectable(arrayType="com.advancedDataGridClasses.AdvancedDataGridColumn")]
     ...
     */
    public function getLines():Sprite
    {
        var lines:Sprite = Sprite(listSubContent.getChildByName("lines"));
        if (!lines)
        {
    ...
    private function findNextItemRenderer(shiftKey:Boolean):Boolean
    {
        ...
        while (!found)
        {
            ...
            // considered.
            // This is not the "right" way because we are checking for
            // existence even before scrolling. But what is the right way...
            ...
            {
                // XXX Assumption that item renderer is never invisible in the
    ...
    mx_internal function columnRendererChanged(c:AdvancedDataGridColumn):void
    {
        ...
        if (measuringObjects)
        {
            ...
            // to do - set valid item to be passed
...
//            return;
    ...
    protected function findSortField(name:String):int
    {
        ...
        {
            for (var i:int = 0; i < collection.sort.fields.length; i++)
            {
                                    ...
                                    collection:ICollectionView):void
    {
        ...
        if (!column.sortable)
         ...
         if (!collection.sort || !collection.sort.fields)
         {
             ...
             // XXX This will work only for flat data, NOT for Hierarchical.
             // After appropriate collection support has been added, this will
            // work for hierarchical data also. No changes required here,
            // just this warning has to be removed.
...
//        field.name = column.dataField;
    ...
    {
        for (var row:int = 0; row < headerItems.length; row++)
        {
            for (var col:int = 0; col < headerItems[row].length; col++)
            {
                if (UIDUtil.getUID(headerItems[row][col]) == UIDUtil.getUID(item))
                    return true;
            }
        }
