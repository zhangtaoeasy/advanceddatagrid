...
{
  import com.controls.MyAdvancedDataGrid;
 ...
 *
 *  @see hk.controls.DataGrid
 *  @see mx.core.IDataRenderer
 *  @see hk.controls.listClasses.IDropInListItemRenderer
 */
public class AdvancedDataGridItemRendererEx extends UITextField
                  ...
                  IListItemRenderer, IStyleClient
{
  ...
  //--------------------------------------------------------------------------
     ...
     *  Constructor.
     */
  public function AdvancedDataGridItemRendererEx()
  {
    super();
  ...
  private var _showData:Boolean = true;
  ...
  */
  ...
  {
    _listData = BaseListData(value);
    if(_listData)
      text = _showData?_listData.label:"";
  ...
  public function set showData(value:Boolean) : void
    {
        _showData = value;
        if (_listData)
        {
     ...
     public function get showData() : Boolean
    {
        return _showData;
    }// end function
    //----------------------------------
  ...
  */
  override public function validateNow():void
  {
    if (data && parent)
    {
      ...
      if (AdvancedDataGridBaseEx(_listData.owner).isItemHighlighted(_listData.uid))
      {
            newColor = getStyle("textRollOverColor");
      }
      else if (AdvancedDataGridBaseEx(_listData.owner).isItemSelected(_listData.uid))
      {
  ...
  */
  public function validateProperties():void
  {
    ...
    if (_listData)
    {
      var dg:MyAdvancedDataGrid = MyAdvancedDataGrid(_listData.owner);
      var column:MergeAdvancedDataGridColumn =
        dg.columns[_listData.columnIndex];
      text = _showData?_listData.label:"";
      if (_data is MergeAdvancedDataGridColumn)
        wordWrap = dg.columnHeaderWordWrap(column);
      else
        wordWrap = dg.columnWordWrap(column);

      if (MyAdvancedDataGrid(_listData.owner).variableRowHeight)
        multiline = true;
      ...
      if (dataTips)
      {
        if (!(_data is MergeAdvancedDataGridColumn) && (textWidth > width
