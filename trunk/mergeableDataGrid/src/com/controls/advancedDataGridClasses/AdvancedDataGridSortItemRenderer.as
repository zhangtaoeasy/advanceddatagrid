...
import com.controls.advancedDataGridClasses.SortInfo;
...
public class AdvancedDataGridSortItemRenderer extends UIComponent
{
    ...
    */
     ...
     *  @see mx.controls.advancedDataGridClasses.SortInfo
     */
    protected function getFieldSortInfo():com.controls.advancedDataGridClasses.SortInfo
    {
        // Parent is the header renderer.
        if (grid && parent is mx.controls.listClasses.IDropInListItemRenderer)
        {
            var listData:AdvancedDataGridListData = (parent as mx.controls.listClasses.IDropInListItemRenderer).listData
     ...
     */
    protected function get grid():com.controls.advancedDataGridClasses.AdvancedDataGrid
    {
        if (parent && mx.core.UIComponent(parent).owner
                            && mx.core.UIComponent(parent).owner is AdvancedDataGrid)
            return mx.core.UIComponent(parent).owner as AdvancedDataGrid;
        else
            return null;
    }
